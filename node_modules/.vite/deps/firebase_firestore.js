...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  ki(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.Ci(e2.leaseTimestampMs, 5e3) && !this.Mi(e2.ownerId) && !this.Si(e2) && !(this.ai || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(D2.FAILED_PRECONDITION, Ae);
    });
  }
  /**
  ...
  Fo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        } else __PRIVATE_logDebug(me, `RPC '${e}' stream ${r2} received:`, i2), P2.mo(i2);
      }
...
function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
  if (t.search(Se) >= 0) throw __PRIVATE_createError(
